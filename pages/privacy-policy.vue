<template>
  <div>
    ...
    <li>
    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Lol elo browser.</p>
    </li>
    <li>
    ...
    <li>
    <p><strong>Website</strong> refers to Lol skill, accessible from <a href="https://lolskill.games/" rel="external nofollow noopener" target="_blank">https://lolskill.games/</a></p>
    </li>
    <li>
    ...
    <h3>Personal Data</h3>
    <p>While using Our Service, We may ask You to provide Us a few data to application work. Personally identifiable information may include:</p>
    <ul>
    <li>
